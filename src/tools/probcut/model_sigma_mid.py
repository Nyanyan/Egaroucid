...
for n_discs in range(61):
    for depth2 in range(10, 60):
        ...
        x_depth1.append(depth1)
        y_depth2.append(depth2)
        s = 13.0 + 5.0 * n_discs / 60 #max(10.0, min(21.0, 18.0 + (21.0 - 18.0) * n_discs / 30)) # d2 = 60
        e = 3.0 + 3.0 * n_discs / 60 #max(5.0, min(13.0, 8.0 + (13.0 - 8.0) * n_discs / 30)) # d2 = 0
...
for n_discs in range(61):
    for depth2 in range(10, 60):
        ...
        x_depth1.append(depth1)
        y_depth2.append(depth2)
        s = 10.0 + 3.0 * n_discs / 60 #max(10.0, min(18.0, 18.0 + (10.0 - 18.0) * n_discs / 30)) # d2 = 60
