...
'''
if int(phase) >= 10:
    additional_params = ' data4_04.dat data4_06.dat data4_07.dat data4_08.dat data4_09.dat data4_10.dat data4_11.dat data4_15.dat data4_99.dat'
else:
...
executable = 'adjust_param_new.out'
