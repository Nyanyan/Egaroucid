...
constexpr int UMIGAME_VALUE_MAX_PLAYER_LOSS_FINITE_MAX = 10;
constexpr int UMIGAME_VALUE_MAX_PLAYER_LOSS_INF = UMIGAME_VALUE_MAX_PLAYER_LOSS_FINITE_MAX + 1;
constexpr int UMIGAME_VALUE_MAX_PLAYER_LOSS_MAX = UMIGAME_VALUE_MAX_PLAYER_LOSS_INF;
