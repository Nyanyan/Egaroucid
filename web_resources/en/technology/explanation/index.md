...
**This page was machine translated by Gemini CLI from the [Japanese version](https://www.egaroucid.nyanyan.dev/ja/technology/explanation/). Please refer to the Japanese version for the official content.**
...
Originally, Egaroucid was developed for the purpose of participating in a programming contest called [CodinGame Othello](https://www.codingame.com/multiplayer/bot-programming/othello-1). Therefore, to create a strong evaluation function while adhering to the contest's unique restriction of "code must be within 100,000 characters," it was devised as a compression of the evaluation function [(Yamana, Hoshino 2026)](https://doi.org/10.1109/TG.2025.3624825), [(Yamana, Hoshino 2024)](http://doi.org/10.20729/00239899), [(Yamana 2022)](https://ipsj.ixsq.nii.ac.jp/records/218735).
...
- (Yamana, Hoshino 2026): T. Yamana and J. Hoshino, "[Compressing the Evaluation Function With Small-Scale Deep Learning on Othello](https://doi.org/10.1109/TG.2025.3624825)," in IEEE Transactions on Games, vol. 18, no. 1, pp. 128-138, March 2026, doi: 10.1109/TG.2025.3624825.
