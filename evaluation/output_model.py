...
for stone_strt in [0, 10, 20, 30, 40, 50]:
    ...
    layer_names = ['line2', 'line3', 'line4', 'diagonal5', 'diagonal6', 'diagonal7', 'diagonal8', 'edge2X', 'triangle', 'edgeblock', 'cross', 'corner9']
    names = []
    ...
    with open('learned_data/' + str(stone_strt) + '_' + str(stone_end) + '.txt', 'w') as f:
        n_weight = 0
        for name in names:
