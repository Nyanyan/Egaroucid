...
- Current completed total: 21,625 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 21,625 position
samples:
...
- 現在の完了数: 21,625 / 8,035,282 局面サンプル。
...
現在の `partial_merged` における先頭21,625局面サンプルの top-1 symmetric accuracy:
