...
- Current completed total: 2,545 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 2,545 position
samples:
...
現在の `partial_merged` における先頭2,545局面サンプルの top-1 symmetric accuracy:
