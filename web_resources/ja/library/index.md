...
<code>cmake --build build_lib --config Release --target egaroucid_cpp_example</code>

<code>.\build_lib\examples\Release\egaroucid_cpp_example.exe</code>

このサンプルは <code>bin/resources</code> を参照します。  
カレントディレクトリはリポジトリルートで実行してください。
