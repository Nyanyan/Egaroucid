/*
    ...
    @file evaluate_simd_experiment_current_fm_tri_type_count_by_type_stream12.hpp
        Isolated current-model + weighted tri-type count-by-pattern-type FM evaluation experiment with streaming dim12 SIMD scoring
    @date 2026
