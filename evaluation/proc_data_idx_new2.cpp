...
constexpr Feature_to_coord feature_to_coord[N_SYMMETRY_PATTERNS] = {
    ...
    // 12 middle edge
    {10, {COORD_B4, COORD_B3, COORD_B2, COORD_C2, COORD_D2, COORD_E2, COORD_F2, COORD_G2, COORD_G3, COORD_G4}}, // 46
    {10, {COORD_D2, COORD_C2, COORD_B2, COORD_B3, COORD_B4, COORD_B5, COORD_B6, COORD_B7, COORD_C7, COORD_D7}}, // 47
    {10, {COORD_E2, COORD_F2, COORD_G2, COORD_G3, COORD_G4, COORD_G5, COORD_G6, COORD_G7, COORD_F7, COORD_E7}}, // 48
    {10, {COORD_B5, COORD_B6, COORD_B7, COORD_C7, COORD_D7, COORD_E7, COORD_F7, COORD_G7, COORD_G6, COORD_G5}}, // 49
    ...
    // 14 wing
    {7,  {COORD_A1, COORD_B1, COORD_H1, COORD_A2, COORD_B2, COORD_B3, COORD_C3, COORD_NO, COORD_NO, COORD_NO}}, // 54
    {7,  {COORD_H1, COORD_G1, COORD_A1, COORD_H2, COORD_G2, COORD_G3, COORD_F3, COORD_NO, COORD_NO, COORD_NO}}, // 55
    {7,  {COORD_A1, COORD_A2, COORD_A8, COORD_B1, COORD_B2, COORD_C2, COORD_C3, COORD_NO, COORD_NO, COORD_NO}}, // 56
    {7,  {COORD_A8, COORD_A7, COORD_A1, COORD_B8, COORD_B7, COORD_C7, COORD_C6, COORD_NO, COORD_NO, COORD_NO}}, // 57
    {7,  {COORD_H1, COORD_H2, COORD_H8, COORD_G1, COORD_G2, COORD_F2, COORD_F3, COORD_NO, COORD_NO, COORD_NO}}, // 58
    {7,  {COORD_H8, COORD_H7, COORD_H1, COORD_G8, COORD_G7, COORD_F7, COORD_F6, COORD_NO, COORD_NO, COORD_NO}}, // 59
    {7,  {COORD_A8, COORD_B8, COORD_H8, COORD_A7, COORD_B7, COORD_B6, COORD_C6, COORD_NO, COORD_NO, COORD_NO}}, // 60
    {7,  {COORD_H8, COORD_G8, COORD_A8, COORD_H7, COORD_G7, COORD_G6, COORD_F6, COORD_NO, COORD_NO, COORD_NO}}, // 61

    // 15 edge + middle edge
    {8, {COORD_A1, COORD_B1, COORD_C2, COORD_D2, COORD_E2, COORD_F2, COORD_G1, COORD_H1, COORD_NO, COORD_NO}}, // 62
    {8, {COORD_A1, COORD_A2, COORD_B3, COORD_B4, COORD_B5, COORD_B6, COORD_A7, COORD_A8, COORD_NO, COORD_NO}}, // 63
    {8, {COORD_H1, COORD_H2, COORD_G3, COORD_G4, COORD_G5, COORD_G6, COORD_H7, COORD_H8, COORD_NO, COORD_NO}}, // 64
    {8, {COORD_A8, COORD_B8, COORD_C7, COORD_D7, COORD_E7, COORD_F7, COORD_G8, COORD_H8, COORD_NO, COORD_NO}}  // 65
};
...
constexpr Joined_pattern joined_pattern_3bit[N_SYMMETRY_PATTERNS] = {
    ...
    // edge + 2Xa
    {1, {0x3C00000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 50
    {1, {0x000000000000003CULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 51
    {1, {0x0000808080800000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 52
    {1, {0x0000010101010000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 53

    // wing
    {1, {0x3E00000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 54
    {1, {0x7C00000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 55
    {1, {0x0000808080808000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 56
    {1, {0x0080808080800000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 57
    {1, {0x0000010101010100ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 58
    {1, {0x0001010101010000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 59
    {1, {0x000000000000003EULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 60
    {1, {0x000000000000007CULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 61

    // edge + middle edge
    {1, {0x3C00000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 62
    {1, {0x0000808080800000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 63
    {1, {0x0000010101010000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 64
    {1, {0x000000000000003CULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}  // 65
};
...
constexpr Joined_pattern joined_pattern_1bit[N_SYMMETRY_PATTERNS] = {
    ...
    // wing
    {1, {0x0000004040400000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 54
    {1, {0x0000000202020000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 55
    {1, {0x001C000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 56
    {1, {0x0000000000001C00ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 57
    {1, {0x0038000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 58
    {1, {0x0000000000003800ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 59
    {1, {0x0000404040000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 60
    {1, {0x0000020202000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL}}, // 61
...
inline void calc_idx(int phase_idx, Board *b, int idxes[]){
    ...
    for (i = 0; i < N_SYMMETRY_PATTERNS; ++i){
        ...
        if (joined_pattern_1bit[i].n_joined == 1){
            idxes[i] *= 2;
