...
- Current completed total: 8,525 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 8,525 position
samples:
...
現在の `partial_merged` における先頭8,525局面サンプルの top-1 symmetric accuracy:
