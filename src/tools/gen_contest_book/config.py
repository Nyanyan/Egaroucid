...
# Contest records should be generated by the same optimized tournament binary
# that consumes the resulting books.  Callers can still override this with
# generate_records.py/generate_all_records.py --exe.
CONSOLE_EXE = ROOT_DIR / "bin" / "Egaroucid_for_Console_clang.exe"
...
DEFAULT_ADVERSARIAL_GAMES_PER_START = 5
DEFAULT_ADVERSARIAL_BATCH_SIZE = 1
DEFAULT_ADVERSARIAL_LEVEL = 19
DEFAULT_ADVERSARIAL_REPLY_MARGIN = 2
DEFAULT_ADVERSARIAL_REPLY_WIDTH = 3
DEFAULT_ADVERSARIAL_ENGINE_WIDTH = 2
DEFAULT_ADVERSARIAL_MAX_ROUNDS = 3
DEFAULT_ADVERSARIAL_STABLE_ROUNDS = 1
BOOK_EXTENSION = ".egcb"
START_INDEX_WIDTH = 7
