...
#define MAX_EVALUATE_IDX_MOVE_ORDERING 59049
#define N_PATTERNS_MOVE_ORDERING_END 4
#define N_PATTERNS_MOVE_ORDERING_MID 8
#define N_SYMMETRY_PATTERNS_MOVE_ORDERING_END 16
#define N_SYMMETRY_PATTERNS_MOVE_ORDERING_MID 30
