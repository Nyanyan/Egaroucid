...
void pattern_speed(){
    ...
    for (uint64_t i = 0; i < N; ++i){
        for (int j = 0; j < N_SIMD_EVAL_FEATURES; ++j){
            data[i].f256[j] = _mm256_set_epi16(
                myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), 
                myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), 
                myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), 
                myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX), myrandrange(0, MAX_EVALUATE_IDX)
            );
