/*
    ...
    @file evaluate_simd_experiment_current_fm_dual_type_simdopt.hpp
        Isolated current-model + weighted dual-type FM evaluation experiment with SIMD-optimized FM scoring
    @date 2026
