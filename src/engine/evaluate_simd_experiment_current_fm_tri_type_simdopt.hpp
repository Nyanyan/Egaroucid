/*
    ...
    @file evaluate_simd_experiment_current_fm_tri_type_simdopt.hpp
        Isolated current-model + weighted tri-type FM evaluation experiment with SIMD-optimized FM scoring
    @date 2026
