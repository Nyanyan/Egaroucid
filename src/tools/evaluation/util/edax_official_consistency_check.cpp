/*
    ...
    @file edax_official_consistency_check.cpp
        Consistency check for the isolated Edax official evaluation experiment.
    @date 2026
...
int main(int argc, char **argv) {
    if (argc < 2) {
        std::cerr << "usage: edax_official_consistency_check <eval.dat> [games] [seed]" << std::endl;
        return 1;
    }
