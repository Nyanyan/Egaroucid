...
constexpr Feature_to_coord feature_to_coord[N_SYMMETRY_PATTERNS] = {
    ...
    // 12 fish
    {10, {COORD_A1, COORD_B1, COORD_A2, COORD_B2, COORD_C2, COORD_D2, COORD_B3, COORD_C3, COORD_B4, COORD_D4}}, // 46
    {10, {COORD_H1, COORD_G1, COORD_H2, COORD_G2, COORD_F2, COORD_E2, COORD_G3, COORD_F3, COORD_G4, COORD_E4}}, // 47
    {10, {COORD_A8, COORD_B8, COORD_A7, COORD_B7, COORD_C7, COORD_D7, COORD_B6, COORD_C6, COORD_B5, COORD_D5}}, // 48
    {10, {COORD_H8, COORD_G8, COORD_H7, COORD_G7, COORD_F7, COORD_E7, COORD_G6, COORD_F6, COORD_G5, COORD_E5}}, // 49
    ...
    // 14 X wing
    {5,  {COORD_A1, COORD_B1, COORD_H1, COORD_B2, COORD_C2, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 54
    {5,  {COORD_H1, COORD_G1, COORD_A1, COORD_G2, COORD_F2, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 55
    {5,  {COORD_A1, COORD_A2, COORD_A8, COORD_B2, COORD_B3, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 56
    {5,  {COORD_A8, COORD_A7, COORD_A1, COORD_B7, COORD_B6, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 57
    {5,  {COORD_H1, COORD_H2, COORD_H8, COORD_G2, COORD_G3, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 58
    {5,  {COORD_H8, COORD_H7, COORD_H1, COORD_G7, COORD_G6, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 59
    {5,  {COORD_A8, COORD_B8, COORD_H8, COORD_B7, COORD_C7, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 60
    {5,  {COORD_H8, COORD_G8, COORD_A8, COORD_G7, COORD_F7, COORD_NO, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 61

    // 15 C wing
    {6,  {COORD_A3, COORD_A2, COORD_A1, COORD_B1, COORD_C2, COORD_H1, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 62
    {6,  {COORD_H3, COORD_H2, COORD_H1, COORD_G1, COORD_F2, COORD_A1, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 63
    {6,  {COORD_C1, COORD_B1, COORD_A1, COORD_A2, COORD_B3, COORD_A8, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 64
    {6,  {COORD_C8, COORD_B8, COORD_A8, COORD_A7, COORD_B6, COORD_A1, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 65
    {6,  {COORD_F1, COORD_G1, COORD_H1, COORD_H2, COORD_G3, COORD_H8, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 66
    {6,  {COORD_F8, COORD_G8, COORD_H8, COORD_H7, COORD_G6, COORD_H1, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 67
    {6,  {COORD_A6, COORD_A7, COORD_A8, COORD_B8, COORD_C7, COORD_H8, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}, // 68
    {6,  {COORD_H6, COORD_H7, COORD_H8, COORD_G8, COORD_F7, COORD_A8, COORD_NO, COORD_NO, COORD_NO, COORD_NO}}  // 69
};
