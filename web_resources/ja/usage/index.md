...
最終更新: 2025/01/07 Egaroucid 7.5.1
...
<b>棋譜形式</b>: f5D6形式の棋譜を入力して局面を設定できます。大文字小文字、スペースは無視されます。パスがある場合は、パスを省略して記述するか、"PA"や"PS"、"pa"、"ps"をパスを表す文字列として使用できます。ただし、パスできない局面でパスすることはできません。<a href="#入出力_出力 > 現局面までの棋譜をコピー">現局面までの棋譜をコピー</a>と対応した機能です。
