"""
Visual Studio を使用して Egaroucid GUI版 をビルドするスクリプト
"""
...
# プロジェクトファイル
SOLUTION_FILE = PROJECT_ROOT / "Egaroucid.sln"
VCXPROJ_FILE = PROJECT_ROOT / "Egaroucid.vcxproj"
...
def build_project(configuration="Release", platform="x64", clean=False, verbose=False):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # 出力ファイルの確認
            output_file = PROJECT_ROOT / "bin" / "Egaroucid.exe"
...
def main():
    parser = argparse.ArgumentParser(
        description="Visual Studio を使用して Egaroucid GUI版 をビルド"
    )
    
    parser.add_argument(
        "-c", "--configuration",
        choices=["Debug", "Release", "SIMD", "SIMD_Portable", "AVX512", "AVX512_Portable", "Generic", "Generic_Portable"],
        default="Release",
