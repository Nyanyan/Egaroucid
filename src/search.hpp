...
const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
    {472, 235, 286, 245, 236, 202, 345, 276},
    {291, 289, 360, 360, 308, 249, 366, 291},
    {434, 476, 293, 388, 424, 396, 383, 431},
    {391, 408, 301, 530, 469, 395, 519, 574},
    {524, 484, 408, 523, 538, 661, 613, 762},
    {515, 449, 400, 526, 510, 363, 534, 536}
};
