...
class Game_information : public App::Scene {
private:
    Button edit_button;
    Button back_button;
...
public:
    Game_information(const InitData& init) : IScene{ init } {
        changing_idx = SHORTCUT_KEY_SETTINGS_IDX_NOT_CHANGING;
        back_button.init(GO_BACK_BUTTON_BACK_SX, GO_BACK_BUTTON_SY, GO_BACK_BUTTON_WIDTH, GO_BACK_BUTTON_HEIGHT, GO_BACK_BUTTON_RADIUS, language.get("common", ""), 25, getData().fonts.font, getData().colors.white, getData().colors.black);
        edit_button.init(GO_BACK_BUTTON_GO_SX, GO_BACK_BUTTON_SY, GO_BACK_BUTTON_WIDTH, GO_BACK_BUTTON_HEIGHT, GO_BACK_BUTTON_RADIUS, language.get("common", "ok"), 25, getData().fonts.font, getData().colors.white, getData().colors.black);
