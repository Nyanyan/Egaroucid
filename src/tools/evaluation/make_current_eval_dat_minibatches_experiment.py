...
def main():
    ...
    try:
        ...
        for train_id in train_ids:
            path = input_phase_dir / f"{train_id}.dat"
            ...
            used_files.append((train_id, size, file_records))
    finally:
    ...
    with summary_path.open("w", encoding="utf-8", newline="\n") as f:
        ...
        f.write("used_files=" + ",".join(f"{tid}:{size}:{records}" for tid, size, records in used_files) + "\n")
