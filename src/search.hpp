...
const int mpcd[30] = {0, 1, 0, 1, 2, 3, 2, 3, 4, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 6, 7, 8, 7, 8, 9, 8, 9};
    ...
    const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
        {52, 51, 59, 114, 127, 131, 167, 190},
        {201, 151, 137, 172, 157, 156, 186, 163},
        {170, 127, 153, 166, 196, 238, 254, 278},
        {233, 269, 233, 410, 370, 297, 374, 375},
        {260, 225, 228, 321, 271, 278, 393, 331},
        {276, 277, 247, 339, 363, 382, 452, 408},
        {335, 318, 292, 355, 393, 448, 468, 443},
        {342, 335, 332, 512, 552, 434, 529, 546},
        {396, 375, 438, 534, 520, 638, 816, 799},
        {524, 340, 350, 398, 357, 282, 327, 255}
    };
    const double mpcsd_final[mpc_max_depth_final - mpc_min_depth_final + 1] = {
        606, 587, 654, 642, 636, 649, 624, 595, 648, 642, 619, 667, 655, 674, 666, 667, 706, 707, 704, 740
    };
#else
    const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
