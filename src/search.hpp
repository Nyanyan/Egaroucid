...
#else
    const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
        {255, 223, 202, 285, 260, 252, 311, 251},
        {305, 235, 206, 283, 291, 293, 269, 261},
        {392, 374, 309, 364, 353, 309, 328, 292},
        {369, 306, 232, 397, 473, 560, 610, 679},
        {680, 595, 716, 799, 740, 572, 677, 601},
        {446, 328, 308, 466, 436, 492, 571, 604},
        {425, 441, 450, 661, 554, 485, 658, 647},
        {504, 482, 497, 539, 461, 483, 636, 596},
        {512, 416, 381, 642, 540, 468, 650, 610},
        {405, 286, 260, 398, 320, 242, 310, 211}
    };
    const double mpcsd_final[mpc_max_depth_final - mpc_min_depth_final + 1] = {
        571, 555, 604, 585, 574, 624, 594, 571, 608, 594, 581, 540, 533, 607, 601, 583, 647, 638, 649, 641
    };
#endif
