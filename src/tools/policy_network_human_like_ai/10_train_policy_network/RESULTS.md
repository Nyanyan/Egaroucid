...
- Current completed total: 3,925 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 3,925 position
samples:
...
現在の `partial_merged` における先頭3,925局面サンプルの top-1 symmetric accuracy:
