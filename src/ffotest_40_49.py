...
if sys.argv[1] == 'g':
    cmd = 'Egaroucid_for_console.exe -l 60 -nobook -thread 23 -solve problem/ffo40-49.txt'
else:
    cmd = 'Egaroucid_console.exe -l 60 -nobook -thread 23 -solve problem/ffo40-49.txt'
print(cmd)
