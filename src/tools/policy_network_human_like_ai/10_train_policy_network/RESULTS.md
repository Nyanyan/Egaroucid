...
- Current completed total: 6,345 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 6,345 position
samples:
...
現在の `partial_merged` における先頭6,345局面サンプルの top-1 symmetric accuracy:
