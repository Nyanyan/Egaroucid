/*
    ...
    @file eval77_beta_score_sample.cpp
        Score sampler for the isolated 7.7 beta linear evaluator.
    @date 2026
...
#ifndef EVALUATE_EXPERIMENT_7_7_BETA
    #define EVALUATE_EXPERIMENT_7_7_BETA
#endif
...
int main(int argc, char **argv) {
    if (argc < 2) {
        std::cerr << "usage: eval77_beta_score_sample <eval.egev2> [positions] [seed]" << std::endl;
        return 1;
    }
