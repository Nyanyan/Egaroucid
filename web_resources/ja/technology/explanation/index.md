...
[この研究](https://ipsj.ixsq.nii.ac.jp/records/2005522)では、オセロの合法局面数を推定しています。その結果、オセロでは有意水準99.5%で$7.91\times 10^{25}$から$4.93\times 10^{26}$の合法局面が存在することがわかったとのことです。
...
引用した論文: 石井颯太郎, 田中哲朗: [オセロの実現可能局面数の推計](https://ipsj.ixsq.nii.ac.jp/records/2005522), ゲームプログラミングワークショップ2025論文集, Vol. 2025, pp.171-178
