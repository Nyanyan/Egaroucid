...
plt.plot(phase_arr, mae_arr, label='train_MAE', color='red', marker='s', linestyle="dotted", linewidth=5)
...
plt.clf()
plt.plot(phase_arr, mse_arr, label='train_MSE', color='orange', marker='s', linestyle="dotted", linewidth=5)
