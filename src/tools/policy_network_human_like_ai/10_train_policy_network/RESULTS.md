...
- Current completed total: 1,065 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 1,065 position
samples:
...
現在の `partial_merged` における先頭1,065局面サンプルの top-1 symmetric accuracy:
