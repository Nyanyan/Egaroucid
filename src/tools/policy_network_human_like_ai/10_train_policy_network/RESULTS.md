...
- Current completed total: 22,385 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 22,385 position
samples:
...
- 現在の完了数: 22,385 / 8,035,282 局面サンプル。
...
現在の `partial_merged` における先頭22,385局面サンプルの top-1 symmetric accuracy:
