...
const Command_info command_data[N_COMMANDS] = {
    ...
    {CMD_ID_SETTIMEMS,  {"settimems"},                                      "<color> <milliseconds>",   "Set <color> (X / B / O / W) player's remaining time to an exact nonnegative millisecond count"},
};
