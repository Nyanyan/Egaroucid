...
オセロというゲームはどれくらいの数の合法な局面(初手からたどり着ける局面)を持つのかを考えてみます。[英語版Wikipedia](https://en.wikipedia.org/wiki/Game_complexity)には$10^{28}$と書いてありますが、$10^{26}$と見込んだ最新研究があるので、これを紹介します。
