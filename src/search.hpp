...
const double mpct[n_phases]={1.7, 1.7, 1.7, 1.7, 1.7, 1.7};
const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
    {163, 327, 317, 157, 242, 309, 227, 300},
    {422, 247, 332, 368, 334, 258, 341, 318},
    {320, 332, 1130, 433, 408, 363, 317, 331},
    {515, 365, 376, 482, 336, 289, 395, 371},
    {389, 310, 310, 418, 400, 331, 417, 424},
    {430, 320, 330, 537, 439, 421, 437, 408},
    {422, 424, 305, 529, 386, 310, 432, 488},
    {402, 349, 309, 471, 399, 365, 421, 392},
    {366, 344, 317, 436, 515, 444, 709, 423},
    {462, 408, 414, 494, 460, 548, 560, 550},
    {453, 490, 444, 804, 659, 768, 733, 677},
    {579, 657, 499, 971, 757, 782, 813, 869},
    {637, 631, 702, 869, 771, 572, 852, 555},
    {504, 414, 418, 561, 443, 327, 469, 407},
    {377, 199, 73, 272, 140, 0, 88, 0}
};
const double mpcsd_final[mpc_max_depth_final - mpc_min_depth_final + 1] = {
    583, 549, 633, 620, 611, 650, 608, 588, 577, 544, 511, 513, 485, 511, 490, 484, 497, 485, 471, 510
};
