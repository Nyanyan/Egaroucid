/*
    ...
    @file evaluate_simd_experiment_current_fm_tri_type_stream12.hpp
        Isolated current-model + weighted tri-type FM evaluation experiment with streaming dim12 SIMD scoring
    @date 2026
