...
#include "setting.hpp"
    ...
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_7_7_fm_subset_simdopt.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_7_7_fm_subset_simdopt.hpp"
    #endif
#endif

#if defined(EVALUATE_EXPERIMENT_7_7_FM_SIMDOPT)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_7_7_fm_simdopt.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_7_7_fm_simdopt.hpp"
    #endif
#endif

#if defined(EVALUATE_EXPERIMENT_7_7_FM_SIMDOPT_MMAP)
    #ifndef EVALUATE_SIMD_HEADER
...
#if defined(EVALUATE_EXPERIMENT_7_7_FM_GROUPED)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_7_7_fm_grouped.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_7_7_fm_grouped.hpp"
    #endif
#endif

#if defined(EVALUATE_EXPERIMENT_7_7_FM_SHARED)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_7_7_fm_shared.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_7_7_fm_shared.hpp"
    #endif
#endif
...
#if defined(EVALUATE_EXPERIMENT_EDAX_LINEAR_CANONICAL)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_edax_linear_canonical.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_edax_linear_canonical.hpp"
    #endif
#endif

#if defined(EVALUATE_EXPERIMENT_EDAX_OFFICIAL)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_edax_official.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_edax_official.hpp"
    #endif
#endif
...
#if defined(EVALUATE_EXPERIMENT_CURRENT_FM_SIMDOPT)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_current_fm_simdopt.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_current_fm_simdopt.hpp"
    #endif
#endif
...
#if defined(EVALUATE_EXPERIMENT_CURRENT_FM_DUAL_TYPE_SIMDOPT)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_current_fm_dual_type_simdopt.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_current_fm_dual_type_simdopt.hpp"
    #endif
#endif
...
#if defined(EVALUATE_EXPERIMENT_CURRENT_FM_TRI_TYPE_STREAM12)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_current_fm_tri_type_stream12.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_current_fm_tri_type_stream12.hpp"
    #endif
#endif

#if defined(EVALUATE_EXPERIMENT_CURRENT_FM_TRI_TYPE_COUNT_BY_TYPE_STREAM12)
    #ifndef EVALUATE_SIMD_HEADER
        #define EVALUATE_SIMD_HEADER "evaluate_simd_experiment_current_fm_tri_type_count_by_type_stream12.hpp"
    #endif
    #ifndef EVALUATE_GENERIC_HEADER
        #define EVALUATE_GENERIC_HEADER "evaluate_generic_experiment_current_fm_tri_type_count_by_type_stream12.hpp"
    #endif
#endif
