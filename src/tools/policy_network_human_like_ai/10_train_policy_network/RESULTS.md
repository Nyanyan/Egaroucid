...
- Current completed total: 9,885 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 9,885 position
samples:
...
現在の `partial_merged` における先頭9,885局面サンプルの top-1 symmetric accuracy:
