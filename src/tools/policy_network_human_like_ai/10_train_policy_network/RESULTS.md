...
- Current completed total: 7,085 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 7,085 position
samples:
...
現在の `partial_merged` における先頭7,085局面サンプルの top-1 symmetric accuracy:
