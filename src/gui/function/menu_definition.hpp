...
Menu create_menu(Menu_elements* menu_elements, Resources *resources, Font font, std::string lang_name) {
    ...
    title.init(language.get("settings", "settings"));
        ...
        title.push(menu_e);
        menu_e.init_button(language.get("settings", "mouse_additional_buttons", "settings") + get_shortcut_key_info(U"mouse_additional_button_setting"), &menu_elements->mouse_additional_button_setting);
        title.push(menu_e);
    menu.push(title);
    ...
    title.init(language.get("operation", "operation"));
        ...
        title.push(menu_e);
        menu_e.init_button(language.get("operation", "go_to_first_position") + get_shortcut_key_info(U"go_to_first_position"), &menu_elements->go_to_first_position);
        title.push(menu_e);
        menu_e.init_button(language.get("operation", "go_to_last_position") + get_shortcut_key_info(U"go_to_last_position"), &menu_elements->go_to_last_position);
        title.push(menu_e);
        menu_e.init_button(language.get("operation", "go_to_random_generated_position") + get_shortcut_key_info(U"go_to_random_generated_position"), &menu_elements->go_to_random_generated_position);
        title.push(menu_e);
        ...
        title.push(menu_e);
        menu_e.init_button(language.get("operation", "generate_xot_board") + get_shortcut_key_info(U"generate_xot_board"), &menu_elements->generate_xot_board);
        title.push(menu_e);
        ...
        menu_e.init_button(language.get("operation", "ai_operation", "ai_operation"), &menu_elements->dummy);
            ...
            menu_e.push(side_menu);
            side_menu.init_button(language.get("operation", "ai_operation", "resume_calculating") + get_shortcut_key_info(U"resume_calculating"), &menu_elements->resume_calculating);
            menu_e.push(side_menu);
