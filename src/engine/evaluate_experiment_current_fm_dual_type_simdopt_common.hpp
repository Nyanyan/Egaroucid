/*
    ...
    @file evaluate_experiment_current_fm_dual_type_simdopt_common.hpp
        Shared loader and SIMD-optimized scorer for the isolated current-model + dual-type FM experiment
    @date 2026
...
#if USE_SIMD
    if (current_fm_cross_file.dim == 16 && current_fm_same_file.dim == 16) {
