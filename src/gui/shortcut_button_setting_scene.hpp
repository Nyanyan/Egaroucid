...
constexpr int SHORTCUT_BUTTON_SETTINGS_N_FUNCTIONS_ON_WINDOW = 9;
constexpr int SHORTCUT_BUTTON_SETTINGS_FUNCTION_LIST_HEIGHT = SHORTCUT_SETTINGS_LIST_ROW_HEIGHT * SHORTCUT_BUTTON_SETTINGS_N_FUNCTIONS_ON_WINDOW;
...
public:
    Shortcut_button_setting(const InitData& init) : IScene{ init } {
        ...
        function_scroll_manager.init(770, SHORTCUT_SETTINGS_SEARCH_RESULT_LIST_SY, 10, SHORTCUT_BUTTON_SETTINGS_FUNCTION_LIST_HEIGHT, 20, (int)shortcut_keys.shortcut_keys.size(), SHORTCUT_BUTTON_SETTINGS_N_FUNCTIONS_ON_WINDOW, SHORTCUT_SETTINGS_LIST_SX, SHORTCUT_SETTINGS_SEARCH_RESULT_LIST_SY, SHORTCUT_SETTINGS_LIST_WIDTH + 10, SHORTCUT_BUTTON_SETTINGS_FUNCTION_LIST_HEIGHT);
    }
