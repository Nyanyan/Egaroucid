...
void Main() {
	...
	while (System::Update()) {
		...
		SimpleGUI::TextBox(play_memo, Vec2(520, 475), 460, inf, !book_learning);
		SimpleGUI::TextBox(black_player, Vec2(520, 510), 200, inf, !book_learning);
		SimpleGUI::TextBox(white_player, Vec2(780, 510), 200, inf, !book_learning);
