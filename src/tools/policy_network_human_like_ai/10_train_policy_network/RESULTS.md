...
- Current completed total: 1,845 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 1,845 position
samples:
...
現在の `partial_merged` における先頭1,845局面サンプルの top-1 symmetric accuracy:
