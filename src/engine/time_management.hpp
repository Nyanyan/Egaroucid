...
#define TIME_MANAGEMENT_REMAINING_TIME_OFFSET 250 // ms / move
#define TIME_MANAGEMENT_REMAINING_TIME_OFFSET_BASE 2500 // ms
// #define TIME_MANAGEMENT_REMAINING_MOVES_OFFSET 15 // 15 * 2 = 30 moves
#define TIME_MANAGEMENT_N_MOVES_COE_30_OR_MORE 1.3 // 1.4
