/*
    ...
    @file edax_official_fm_score_sample.cpp
        Score sampler for SIMD/Generic comparison of the official-Edax + FM evaluator.
    @date 2026
...
int main(int argc, char **argv) {
    if (argc < 2) {
        std::cerr << "usage: edax_official_fm_score_sample <eval.dat[@fm.egev4]> [positions] [seed]" << std::endl;
        return 1;
    }
