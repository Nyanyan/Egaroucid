...
このページでは各機能の使い方の説明にとどめますが、実際にそれらの機能をどう活用すれば良いのかという内容については別のページに書きました。

<ul>
    <li><a href="./book">Book詳説</a></li>
</ul>
...
<ul>
    <li>対局
        <ul>
            <li><a href="#対局_新規対局 (人間同士)">新規対局 (人間同士)</a> N (New game)</li>
        </ul>
    </li>
    <li>設定
        <ul>
...
なお、この設定にはチェックボックスがついています。チェックを外すとその項目が無制限として計算されます。
