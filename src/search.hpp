...
constexpr int parity_vacant_bonus = step;
...
const double mpcsd[n_phases][mpc_max_depth - mpc_min_depth + 1]={
    ...
    {287, 231, 231, 303, 299, 288, 356, 250},
    {357, 339, 295, 317, 323, 327, 304, 307},
    {452, 325, 298, 432, 458, 349, 428, 382},
    {392, 364, 324, 419, 432, 407, 429, 397},
    {346, 444, 363, 540, 481, 350, 461, 395},
    {404, 392, 350, 521, 469, 434, 482, 501},
    {407, 409, 364, 627, 505, 419, 510, 547},
    {541, 501, 409, 625, 584, 611, 610, 653},
    {562, 567, 425, 657, 675, 522, 588, 559},
