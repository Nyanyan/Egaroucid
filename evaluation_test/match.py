...
egaroucid5_dnn = subprocess.Popen(('Egaroucid5_test.exe ' + str(level) + ' learned_data/eval_dnn.egev').split(), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.DEVNULL)
