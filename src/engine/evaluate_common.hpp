...
*/
// disc patterns
#if defined(EVALUATE_EXPERIMENT_EDAX_LINEAR) || defined(EVALUATE_EXPERIMENT_EDAX_LINEAR_CANONICAL) || defined(EVALUATE_EXPERIMENT_EDAX_FM) || defined(EVALUATE_EXPERIMENT_EDAX_OFFICIAL) || defined(EVALUATE_EXPERIMENT_EDAX_OFFICIAL_FM)
constexpr int N_PATTERNS = 13;          // Edax linear model pattern groups
#else
constexpr int N_PATTERNS = 16;          // number of patterns used
#endif
#if defined(EVALUATE_EXPERIMENT_7_7_BETA) || defined(EVALUATE_EXPERIMENT_7_7_FM) || defined(EVALUATE_EXPERIMENT_7_7_FM_SIMDOPT) || defined(EVALUATE_EXPERIMENT_7_7_FM_SIMDOPT_MMAP) || defined(EVALUATE_EXPERIMENT_7_7_FM_SUBSET_SIMDOPT)
