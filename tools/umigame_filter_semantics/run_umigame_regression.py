...
DEFAULT_BOOK = REPO_ROOT / "bin" / "resources" / "book.egbk3"
...
def main() -> None:
    ...
    parser.add_argument("--errors", default="0,2,4", help="comma-separated Errors per Move values")
    parser.add_argument("--display", default="inf:inf,0:0,4:2,2:4", help="comma-separated B:W display filters")
