...
- Current completed total: 9,125 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 9,125 position
samples:
...
現在の `partial_merged` における先頭9,125局面サンプルの top-1 symmetric accuracy:
