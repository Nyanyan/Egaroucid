...
- Current completed total: 145 / 8,035,282 position samples.
...
Current `partial_merged` top-1 symmetric accuracy on the first 145 position
samples:
...
現在の `partial_merged` における先頭145局面サンプルの top-1 symmetric accuracy:
